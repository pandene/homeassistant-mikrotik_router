...
SENSOR_TYPES: tuple[MikrotikSensorEntityDescription, ...] = (
    ...
    MikrotikSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_category=EntityCategory.DIAGNOSTIC,
        ha_group="data__dst-address",
        data_path="route",
        data_attribute="distance",
        data_name="dst-address",
        data_uid="",
        data_reference="dst-address",
    ),
    MikrotikSensorEntityDescription(
        key="route_gateway",
        name="Route Gateway",
        ...
        ha_group="data__dst-address",
        data_path="route",
        data_attribute="gateway",
        data_name="dst-address",
        data_uid="",
        data_reference="dst-address",
    ),
    MikrotikSensorEntityDescription(
        key="route_routing_table",
        name="Route Routing Table",
        icon="mdi:table",
        native_unit_of_measurement="",
        device_class=None,
        state_class=None,
    ...
    MikrotikSensorEntityDescription(
        key="route_target_scope",
        name="Route Target Scope",
        icon="mdi:sigma",
        native_unit_of_measurement="",
        device_class=None,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    MikrotikSensorEntityDescription(
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        ha_group="data__name",
        data_path="queue_type",
        data_attribute="pcq-rate",
        data_name="name",
        data_uid="",
        data_reference="name",
    ),
    ...
    MikrotikSensorEntityDescription(
        ...
        entity_category=None,
        ha_group="data__name",
        data_path="queue_tree",
        data_attribute="bytes",
        data_name="name",
        data_uid="",
        data_reference="name",
    ),
    MikrotikSensorEntityDescription(
        key="queue_tree_total",
        name="Queue Total",
        icon="mdi:transfer",
        native_unit_of_measurement=UnitOfInformation.BYTES,
        suggested_unit_of_measurement=UnitOfInformation.GIGABYTES,
    ...
    MikrotikSensorEntityDescription(
        ...
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        ha_group="data__new-packet-mark",
        ha_connection=DOMAIN,
        ha_connection_value="data__new-packet-mark",
        data_path="mangle",
        data_attribute="bytes",
        data_name="new-packet-mark",
        data_uid="",
        data_reference="new-packet-mark",
        func="MikrotikSensor",
    ),
    MikrotikSensorEntityDescription(
        key="mangle_packets",
        ...
        icon="mdi:package",
        native_unit_of_measurement="pkts",
        device_class=None,
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        ha_group="data__new-packet-mark",
